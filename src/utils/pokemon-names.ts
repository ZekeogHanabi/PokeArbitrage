/**
 * Diccionario de nombres de Pokémon (Gen 1-9) y entrenadores/personajes comunes.
 * Se usa para aislar de forma exacta el nombre del personaje/Pokémon de un título.
 */

// Nombres de múltiples palabras (se deben buscar primero para evitar falsos positivos parciales)
export const MULTI_WORD_NAMES = [
  ...
  'alolan meowth', 'alolan ninetales', 'galarian zapdos',
  'hisui growlithe', 'hisui lilligant', 'hisui arcanine',
  'hisuian growlithe', 'hisuian lilligant', 'hisuian arcanine',
  'hisuian zorua', 'hisuian zoroark', 'hisuian braviary',
  'hisuian electrode', 'hisuian samurott', 'hisuian sliggoo',
  'hisuian goodra', 'hisuian avalugg', 'hisuian typhlosion',
  'hisuian decidueye', 'hisuian sneasler', 'hisuian qwilfish',
  'charlotte pudding', 'monkey d luffy', 'vinsmoke reiju',
  'professor turo', 'professor oak', 'professor sadas', 'professor sada',
  'aether foundation employee', 'boss\'s orders', 'bosses orders',
  'battle partners n', 'rocket\'s zapdos', 'rockets zapdos',
  'blastoise piplup', 'reshiram charizard', 'marshadow machamp',
  'marnie\'s morpeko', 'marnies morpeko', 'hop\'s zacian', 'hops zacian',
  'ethan\'s typhlosion', 'ethans typhlosion', 'lt surge\'s raichu',
  'lt surges raichu', 'n\'s zekrom', 'ns zekrom', 'brock\'s graveler',
  'brocks graveler', 'brock\'s grit', 'brocks grit', 'morty\'s conviction',
  'mortys conviction', 'mega sharpedo', 'mega gengar', 'mega charizard x',
  'mega charizard y', 'mega charizard', 'mega sharpedo', 'mega lopunny jigglypuff',
  'mega lopunny', 'mega sableye amp tyranitar', 'mega sableye', 'mega latios',
  'mega froslass', 'mega eelektross', 'mega kangaskhan', 'mega eelektross',
  'teal mask ogerpon', 'shining magikarp', 'shining genesect'
];

// Nombres de Pokémon de una sola palabra
export const SINGLE_WORD_NAMES = [
  ...
  'slowpoke', 'slowbro', 'magnemite', 'magneton', 'farfetch\'d', 'farfetchd', 'doduo', 'dodrio', 'seel', 'dewgong',
  ...
  'ralts', 'kirlia', 'gardevoir', 'gallade', 'surskit', 'masquerain', 'shroomish', 'breloom', 'slakoth', 'vigoroth',
  ...
  'baltoy', 'claydol', 'lileep', 'cradily', 'anorith', 'armaldo', 'feebas', 'milotic', 'castform',
  'kecleon', 'shuppet', 'banette', 'duskull', 'dusclops', 'tropius', 'chimecho', 'absol', 'wynaut',
  'snorunt', 'glalie', 'spheal', 'sealeo', 'walrein', 'clamperl', 'huntail', 'gorebyss', 'relicanth',
  ...
  'bronzong', 'bonsly', 'happiny', 'chatot', 'spiritomb', 'gible', 'gabite', 'garchomp', 'munchlax',
  ...
  'leafeon', 'glaceon', 'gliscor', 'mamoswine', 'porygon-z', 'probopass', 'dusknoir', 'froslass',
  ...
  'tympole', 'palpitoad', 'seismitoad', 'throh', 'sawk', 'sewaddle', 'swadoon', 'leavanny',
  ...
  'spewpa', 'vivillon', 'litleo', 'pyroar', 'flabébé', 'floette', 'florges', 'skiddo', 'gogoat',
  'pancham', 'pangoro', 'frufrou', 'furfrou', 'espurr', 'meowstic', 'honedge', 'doublade',
  ...
  'goomy', 'sliggoo', 'goodra', 'phantump', 'trevenant', 'pumpkaboo', 'gourgeist', 'bergmite',
  ...
  'sandygast', 'palossand', 'pyukumuku', 'silvally', 'minior', 'komala', 'turtonator', 'togedemaru',
  'mimikyu', 'bruxish', 'drampa', 'dhelmise', 'ogerpon', 'archaludon', 'hydrapple', 'terapagos',
  'pecharunt',
  ...
  'drednaw', 'yamper', 'boltund', 'rolycoly', 'carkol', 'coalosal', 'applin', 'flapple', 'appletun',
  ...
  'shroodle', 'grafaiai', 'toedscool', 'toedscruel', 'klawf', 'capsakid', 'scovillain', 'rellor',
  'rabsca', 'flittle', 'espathra', 'tinkatink', 'tinkatuff', 'tinkaton', 'wiglett', 'wugtrio',
  'bombirdier', 'finizen', 'palafin', 'varoom', 'revavroom', 'orthworm', 'glimmet', 'glimmora',
  'greavard', 'houndstone', 'flamigo', 'cetoddle', 'cetitan', 'veluza', 'dondozo', 'tatsugiri',
  'annihilape', 'clodsire', 'farigaraf', 'dudunsparce', 'kingambit', 'frigibax', 'arctibax',
  'baxcalibur', 'gimmighoul', 'gholdengo',
  // Entrenadores y personajes comunes (incluyendo One Piece y otros juegos de cartas populares de la DB)
  'caitlin', 'briar', 'bill', 'roxanne', 'mars', 'jessie', 'james', 'marnie', 'hop', 'lillie',
  'cynthia', 'viola', 'shanks', 'luffy', 'reiju', 'pudding', 'sett', 'morty', 'n', 'turo',
  'oak', 'luke', 'leia', 'serena', 'iono', 'erika', 'elisa', 'sabrina', 'giovanni', 'misty',
  'brock', 'koga', 'blaine', 'surge'
];

export const POKEMON_NAMES_SET = new Set([...SINGLE_WORD_NAMES, ...MULTI_WORD_NAMES]);
